...
const ui = Object.fromEntries(['remaining','pour-state','caught','spilled','result','final-caught','final-spilled','again','hint','audio-test'].map(id => [id, document.getElementById(id)]));
...
function reset() {
  state = { glassX: 290, time: 0, emitted: 0, caught: 0, spilled: 0, drops: [], splashes: [], holding: false, pointer: null, offset: 0, started: false, done: false, keys: new Set(), flash: 0 };
