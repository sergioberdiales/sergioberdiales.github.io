...
## v0.10.0 — Cuarenta preguntas y memoria entre partidas

- Retiradas las ocho preguntas de v0.9.0 por petición expresa; conservadas en su versión histórica.
- Incorporadas las 15 propuestas del usuario, con sus comentarios y precisiones factuales documentadas, y 25 preguntas adicionales verificadas. Total: 40, en 21 categorías; 10 easy, 24 medium, 6 hard. Fuentes y notas en PREGUNTAS.md, generado desde los mismos datos del juego.
- IDs permanentes; getNextQuestion() sortea entre las no vistas, prefiere otra categoría y guarda en localStorage al mostrar. Reinicia solo al agotar el banco y evita repetir la última entre ciclos. Tolera IDs retirados, JSON dañado y almacenamiento bloqueado (memoria de sesión).
- Claves: culin_felix_seen_questions, culin_felix_last_question, culin_felix_last_category.
- Resultado con «✓ ¡Esa ye!» o «✗ Nun ye esa.», respuesta correcta y comentario en párrafos separados, tanto al acertar como al fallar.
- Precisiones: doce reyes excluyendo expresamente a Nepociano; Covadonga precede a Ordesa en 1918; panera como rasgo habitual; escoba en teitos; curadillos sin tamaño obligatorio; Buferrera sin lista exhaustiva. Fútbol con corte 2025/26: 42 temporadas del Sporting y 39 del Oviedo. Naranco y tradición jacobea con sus matices.
- Verificación: 4.000 selecciones con recarga simulada, 100 ciclos completos; casos vacíos, corruptos, retirados, cuota agotada, categorías y banco de una pregunta. Pruebas de todas las respuestas, doble pulsación, mecánica y audio superadas. Comparación automática confirma código de física, dibujo, entrada y audio intacto respecto a v0.9.0.
- Navegador: varias rondas completadas mediante simulación del escanciado y respuestas con clic real; persistencia al recargar, IDs antiguos, historial vacío y salto de ciclo comprobados. Auditoría adicional de 80 preguntas en 2 ciclos con comentarios de acierto y fallo. Juego independiente sin errores de consola; el entorno de inspección del iframe emitió un error de MutationObserver ajeno al código del juego.
- Publicación prevista en la raíz y /v10/, conservando las versiones anteriores y el resto del repositorio de GitHub Pages.

## v0.11.0 — Un poco más de muñeca

- Balanceo de la botella un 28 % más rápido: frecuencias de 2,9/5,8 a 3,7/7,4 radianes por segundo.
- Amplitud angular de 0,19 a 0,25 radianes (+32 %), manteniendo la botella sujeta a la mano.
- Recorrido del chorro ligeramente mayor: 2 unidades adicionales de amplitud, conservando el ancho del vaso, controles y duración de seis segundos.
- Comprobaciones: mecánica, colisiones, conservación de gotas, preguntas, historial y audio superados. En cuatro fases de prueba, mejor posición inmóvil 70 % (v10: 72 %) y seguimiento preciso 100 %.
- Banco de 40 preguntas y documentación sin cambios.
- Nueva copia jugable en /v11/; /v10/ se exporta desde su etiqueta inmutable, al igual que las versiones anteriores.
