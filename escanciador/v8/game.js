...
const SETTINGS = { duration: 6, rate: 100, glassY: 350, glassWidth: 28, minX: 270, maxX: 318 };
...
function streamVelocity(m) {
  const target=(SETTINGS.minX+SETTINGS.maxX)/2+(SETTINGS.maxX-SETTINGS.minX)/2*pourSway();
...
function drawGlass() {
  ...
  line([[x-17,y+36],[x-10,y+43],[x+1,y+43]],'#eab087',9);
